...
FLAGS = flags.FLAGS
flags.DEFINE_string('name', 'rnnt-m-bpe', help='session name')
...
flags.DEFINE_float('lr', 8e-4, help='initial lr') 
...
flags.DEFINE_float('sched_factor', 0.7, help='lr reduce rate on plateau')
flags.DEFINE_float('sched_min_lr', 1e-6, help='lr reduce rate on plateau')
flags.DEFINE_integer('warmup_step', 5000, help='linearly warmup lr')
flags.DEFINE_integer('epochs', 60, help='epoch')
flags.DEFINE_integer('batch_size', 128, help='batch size')
flags.DEFINE_integer('sub_batch_size', 7, help='accumulate batch size')
...
flags.DEFINE_integer('enc_hidden_size', 1024, help='encoder hidden dimension')
flags.DEFINE_integer('enc_layers', 6, help='encoder layers')
flags.DEFINE_integer('enc_proj_size', 640, help='encoder layers')
...
flags.DEFINE_integer('dec_proj_size', 640, help='encoder layers')
flags.DEFINE_float('dec_dropout', 0.1, help='decoder dropout')
# joint
flags.DEFINE_integer('joint_size', 640, help='Joint hidden dimension')
# tokenizer
flags.DEFINE_enum('tokenizer', 'bpe', ['char', 'bpe'], help='tokenizer')
flags.DEFINE_integer('bpe_size', 2048, help='BPE vocabulary size')
flags.DEFINE_integer('vocab_embed_size', 64, help='vocabulary embedding size')
# data preprocess
flags.DEFINE_float('audio_max_length', 14, help='max length in seconds')
flags.DEFINE_enum('feature', 'logfbank', ['mfcc', 'melspec', 'logfbank'],
                  help='audio feature')
...
flags.DEFINE_integer('hop_length', 320, help='spectrogram')
